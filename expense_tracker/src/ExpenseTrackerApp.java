  ...
  public static void main(String[] args) {
    ...
    view.addTableSelectionListener(e -> {
      if (!e.getValueIsAdjusting()) {
        ...
        // If no row is selected or if the last row that is the TOTAL COUNT ROW is
        // selected we do not change the selectedRow variable
        if (selectedRow != -1 && view.getTransactionsTable().getRowCount() != selectedRow + 1) {
